...
var formdata = new FormData(); // Form Data for Login/Register (user_name/email)
var newformdata = new FormData(); // Form Data after login (user_id/user_guid)
var getimgformdata = new FormData(); // Form Data for getting image data (user_id/user_guid/message_id)
var deleteformdata = new FormData(); // Form Data for deleting msg (user_id/user_guid/message_id)
...
function getMsgDetails() {
    ...
    fetch(req).then(function (response) {
        ...
        console.log(data);
        var title = document.getElementById("msgfrom");
        title.innerHTML = "FROM: " + fromuser;
        ...
        imgTag.addEventListener("load", function(ev){
            ...
            //var bitID = BITS.getUserId(newCanvas);
...
function sendMessage() {
    ...
    var select = document.getElementById("user-list");
    var useridtosend = select.value;  // select.selectedIndex  select.selectedValue  select.options[select.selectedIndex].value
